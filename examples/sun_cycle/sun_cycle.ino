...
void setup() {
	...
	Serial.println(
	    "Connect WiFi so configTzTime can sync time, or set system clock/TZ manually before "
	    "running."
	);
	...
	SunCycleResult nycRise =
	    solar.sunrise(40.7128f, -74.0060f, "EST5EDT,M3.2.0/2,M11.1.0/2", today);
	if (nycRise.ok) {
